...
.scrim{position:absolute;inset:0;z-index:1;background:linear-gradient(180deg,rgba(6,30,59,.50) 0%,rgba(6,30,59,.24) 32%,rgba(6,30,59,.46) 64%,rgba(6,30,59,.88) 100%)}
.scrim-deep{background:linear-gradient(180deg,rgba(6,30,59,.64) 0%,rgba(6,30,59,.56) 50%,rgba(6,30,59,.84) 100%)}
.fill{flex:1}
