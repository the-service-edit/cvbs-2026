...
.scrim{position:absolute;inset:0;z-index:1;
 background:linear-gradient(180deg,rgba(6,30,59,.46) 0%,rgba(6,30,59,.20) 30%,rgba(6,30,59,.40) 62%,rgba(6,30,59,.86) 100%)}
.scrim-soft{background:linear-gradient(180deg,rgba(6,30,59,.34) 0%,rgba(6,30,59,.16) 45%,rgba(6,30,59,.74) 100%)}
.scrim-deep{background:linear-gradient(180deg,rgba(6,30,59,.62) 0%,rgba(6,30,59,.55) 50%,rgba(6,30,59,.82) 100%)}
.fill{flex:1}
